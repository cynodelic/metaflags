...
#ifndef CYNODELIC_METAFLAGS_TEST_PARSER_DEFAULT_PARAMETERS_HPP
#define CYNODELIC_METAFLAGS_TEST_PARSER_DEFAULT_PARAMETERS_HPP


CYNODELIC_TESTER_TEST_CASE(parser_default_parameters);

CYNODELIC_TESTER_SECTION(parser_default_parameters,all_long_flags_called)
{
	...
	CYNODELIC_TESTER_CHECK_EQUALS(prs::finished_at(),9);
...
CYNODELIC_TESTER_SECTION(parser_default_parameters,single_long_flag_called)
{
	using prs = mfl::parser<
		mfl::flag<STRING_("first,f"),STRING_("..."),mfl::i32_arg<>>,
		mfl::flag<STRING_("second,s"),STRING_("..."),mfl::i32_arg<>,mfl::i32_arg<>>,
...
CYNODELIC_TESTER_SECTION(parser_default_parameters,two_long_flags_called)
{
	using prs = mfl::parser<
		mfl::flag<STRING_("first,f"),STRING_("..."),mfl::i32_arg<>>,
		mfl::flag<STRING_("second,s"),STRING_("..."),mfl::i32_arg<>,mfl::i32_arg<>>,
...
CYNODELIC_TESTER_SECTION(parser_default_parameters,all_short_flags_called)
{
	using prs = mfl::parser<
		mfl::flag<STRING_("first,f"),STRING_("..."),mfl::i32_arg<>>,
		mfl::flag<STRING_("second,s"),STRING_("..."),mfl::i32_arg<>,mfl::i32_arg<>>,
...
CYNODELIC_TESTER_SECTION(parser_default_parameters,single_short_flag_called)
{
	using prs = mfl::parser<
		mfl::flag<STRING_("first,f"),STRING_("..."),mfl::i32_arg<>>,
		mfl::flag<STRING_("second,s"),STRING_("..."),mfl::i32_arg<>,mfl::i32_arg<>>,
...
CYNODELIC_TESTER_SECTION(parser_default_parameters,two_short_flags_called)
{
	using prs = mfl::parser<
		mfl::flag<STRING_("first,f"),STRING_("..."),mfl::i32_arg<>>,
		mfl::flag<STRING_("second,s"),STRING_("..."),mfl::i32_arg<>,mfl::i32_arg<>>,
...
CYNODELIC_TESTER_SECTION(parser_default_parameters,no_flags_called)
{
	using prs = mfl::parser<
		mfl::flag<STRING_("first,f"),STRING_("..."),mfl::i32_arg<>>,
		mfl::flag<STRING_("second,s"),STRING_("..."),mfl::i32_arg<>,mfl::i32_arg<>>,
	...
	CYNODELIC_TESTER_MESSAGE
		<< "prs::finished_at() = " << prs::finished_at();
	CYNODELIC_TESTER_MESSAGE
		<< "prs::finished_at() = " << prs::last_parsed_argument_position();

	CYNODELIC_TESTER_CHECK_EQUALS(prs::starts_at(),1);
	CYNODELIC_TESTER_CHECK_EQUALS(prs::last_parsed_argument_position(),1);
	CYNODELIC_TESTER_CHECK_EQUALS(prs::finished_at(),0);

	CYNODELIC_TESTER_CHECK_EQUALS((GET_ARG(prs,"--first",0,0)),0);
	CYNODELIC_TESTER_CHECK_EQUALS((GET_ARG(prs,"--second",0,0)),0);
	CYNODELIC_TESTER_CHECK_EQUALS((GET_ARG(prs,"--second",1,0)),0);
	CYNODELIC_TESTER_CHECK_EQUALS((GET_ARG(prs,"--third",0,0)),0);
	CYNODELIC_TESTER_CHECK_EQUALS((GET_ARG(prs,"--third",1,0)),0);
	CYNODELIC_TESTER_CHECK_EQUALS((GET_ARG(prs,"--third",2,0)),0);
	CYNODELIC_TESTER_CHECK_EQUALS((GET_ARG(prs,"-f",0,0)),0);
	CYNODELIC_TESTER_CHECK_EQUALS((GET_ARG(prs,"-s",0,0)),0);
	CYNODELIC_TESTER_CHECK_EQUALS((GET_ARG(prs,"-s",1,0)),0);
	CYNODELIC_TESTER_CHECK_EQUALS((GET_ARG(prs,"-t",0,0)),0);
	CYNODELIC_TESTER_CHECK_EQUALS((GET_ARG(prs,"-t",1,0)),0);
	...
	CYNODELIC_TESTER_CHECK_FALSE((WAS_CALLED(prs,"--first")));
	CYNODELIC_TESTER_CHECK_FALSE((WAS_CALLED(prs,"--second")));
	CYNODELIC_TESTER_CHECK_FALSE((WAS_CALLED(prs,"--third")));
}


#endif // CYNODELIC_METAFLAGS_TEST_PARSER_DEFAULT_PARAMETERS_HPP
